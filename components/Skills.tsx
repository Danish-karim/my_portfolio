...
const getExpertiseLabel = (level: number) => {
  if (level >= 90)
    return { label: "Expert", badgeClass: "bg-primary-600 text-white" };
  if (level >= 80)
    return { label: "Advanced", badgeClass: "bg-primary-100 text-primary-700" };
  return { label: "Proficient", badgeClass: "bg-gray-100 text-gray-700" };
};
...
const Skills = () => {
  ...
  return (
    <section
      id="skills"
      className="py-20 md:py-32 bg-gradient-to-br from-slate-50 via-white to-primary-50/30"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-100/80 text-primary-700 text-sm font-semibold mb-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {skillCategories.map((category, categoryIndex) => (
            <motion.div
              ...
              className="group relative bg-white rounded-2xl border border-slate-200/80 shadow-sm hover:shadow-xl hover:border-primary-200/60 transition-all duration-300 overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-primary-50/0 to-primary-50/30 group-hover:to-primary-50/50 transition-colors duration-300" />
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-slate-400 text-sm tabular-nums w-10 text-right">
                            {skill.level}%
                          </span>
                        </div>
                      </motion.div>
